...
REM BFCPEEXE=C:\Users\Ethereal\Documents\GitHub\audiotracksmerger\Audio Tracks Merger v0.1.3.exe
REM BFCPEICON=C:\Users\Ethereal\Documents\!Koding\favicon.ico
REM BFCPEICONINDEX=1
REM BFCPEEMBEDDISPLAY=1
REM BFCPEEMBEDDELETE=0
REM BFCPEVERINCLUDE=1
REM BFCPEVERVERSION=0.1.2.0
REM BFCPEVERPRODUCT=Audio Tracks Merger
REM BFCPEVERDESC=Merge multiple audio tracks in a video
REM BFCPEVERCOMPANY=etherealxx
REM BFCPEVERCOPYRIGHT=
REM BFCPEEMBED=F:\!OBSRec3Tera\ffmpeg.exe
REM BFCPEOPTIONEND
@ECHO ON
@echo on
color 0b
